...
INSERT INTO weapon_types (weapon_type_id, weapon_type, color) VALUES
    (1,  'Sword',  'Red'),
    (2,  'Lance',  'Blue'),
    (3,  'Axe',   'Green'),
    (4,  'Staff',  'Colorless'),
...
CREATE TABLE IF NOT EXISTS origins (
    ...
    title        TEXT    NOT NULL,
    series_order INTEGER NOT NULL         -- for sorting chronologically
);

INSERT INTO origins (origin_id, code, title, series_order) VALUES
    (18, 'FEH',  'Heroes',                               1),
    (11, 'FE11', 'Shadow Dragon / New Mystery of the Emblem', 2),
    (2,  'FE2',  'Gaiden / Echoes: Shadows of Valentia', 3),
    ...
    (19, 'TMS',  'Tokyo Mirage Sessions #FE Encore',     18),
    (17, 'FE17', 'Engage',                               19)
;
